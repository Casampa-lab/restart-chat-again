...
export const RECONCILIACAO_CONFIG: Record<GrupoElemento, ReconciliacaoConfig> = {
  ...
  cilindros: {
    ...
    camposComparacao: ['local_implantacao', 'cor_corpo', 'cor_refletivo', 'tipo_refletivo', 'quantidade', 'km_inicial', 'km_final'],
    iconeProjeto: '🔴',
    iconeCadastro: '📷',
    tipoGeometria: 'linear',
    recorrente: true,
  ...
  tachas: {
    ...
    camposComparacao: ['local_implantacao', 'corpo', 'refletivo', 'cor_refletivo', 'quantidade', 'km_inicial', 'km_final'],
    iconeProjeto: '💎',
    iconeCadastro: '📷',
    tipoGeometria: 'linear',
    recorrente: true,
