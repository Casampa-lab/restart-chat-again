  ...
  ficha_placa_intervencoes: [
    {
      ...
      campos: [
        ...
        { campo: 'latitude', label: 'Latitude', tipo: 'text', mask: 'gps' },
        { campo: 'longitude', label: 'Longitude', tipo: 'text', mask: 'gps' },
    ...
    },
    {
      ...
      campos: [
        ...
        { campo: 'quantidade_suporte', label: 'Qtd. Suportes', tipo: 'number' },
      ],
    },
    {
