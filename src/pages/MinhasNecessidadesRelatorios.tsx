...
const CAMPOS_SUPRA: Record<string, Array<{ field: string | null; header: string }>> = {
  ...
  defensas: [
    ...
    { field: "longitude_final", header: "Longitude final" },
    { field: "lado", header: "Lado" },
    { field: "quantidade_laminas", header: "Quantidade lâminas" },
    { field: "comprimento_total_tramo_m", header: "Comprimento Total do Tramo (m)" },
    { field: "funcao", header: "Função" },
    { field: "especificacao_obstaculo_fixo", header: "Especificação do obstáculo fixo" },
    { field: "id_defensa", header: "ID" },
    { field: "distancia_pista_obstaculo_m", header: "Distância da pista ao obstáculo (m)" },
    { field: "risco", header: "Risco" },
    { field: "velocidade_kmh", header: "Velocidade (km/h)" },
    { field: "vmd_veic_dia", header: "VMD (veíc./dia)" },
    { field: "percentual_veiculos_pesados", header: "% veículos pesados" },
    { field: "geometria", header: "Geometria" },
    { field: "classificacao_nivel_contencao", header: "Classificação do nível de contenção" },
    { field: "nivel_contencao_en1317", header: "Nível de contenção EN 1317-2" },
    { field: "nivel_contencao_nchrp350", header: "Nível de contenção NCHRP 350" },
    { field: "espaco_trabalho", header: "Espaço de trabalho" },
    { field: "terminal_entrada", header: "Terminal de entrada" },
    { field: "terminal_saida", header: "Terminal de saída" },
    { field: "adequacao_funcionalidade_lamina", header: "Adequação à funcionalidade - Lâmina" },
    { field: "adequacao_funcionalidade_laminas_inadequadas", header: "Adequação à funcionalidade - Lâminas inadequadas" },
    { field: "adequacao_funcionalidade_terminais", header: "Adequação à funcionalidade - Terminais" },
    { field: "adequacao_funcionalidade_terminais_inadequados", header: "Adequação à funcionalidade - Terminais inadequados" },
    { field: "distancia_face_defensa_obstaculo_m", header: "Distância da face da defensa ao obstáculo(m)" },
    { field: "distancia_bordo_pista_face_defensa_m", header: "Distância da linha de bordo da pista à face da defensa (m)" },
    { field: "link_fotografia", header: "Link da Fotografia" },
  ],
};
