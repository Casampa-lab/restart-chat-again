...
interface NecessidadeInscricao {
  id: string;
  rodovia_id: string;
  lote_id: string;
  sigla: string;
...
export default function MapaNecessidadesInscricoes() {
  ...
  const [selectedNecessidade, setSelectedNecessidade] = useState<NecessidadeInscricao | null>(null);
  ...
  const { data: necessidades, isLoading } = useQuery({
    queryKey: ['necessidades-inscricoes-mapa', loteId, rodoviaId],
    queryFn: async () => {
      let query = supabase
      ...
      return (data || []) as NecessidadeInscricao[];
    },
  ...
  useEffect(() => {
    ...
    const necessidadesFiltradas = necessidades.filter(nec => {
      const matchSearch = searchTerm === '' || 
        nec.sigla?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  return (
    <div className="container mx-auto p-6 h-screen flex flex-col">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">➡️ Mapa de Necessidades - Inscrições</h1>
          ...
          <CardHeader>
            ...
            <div className="space-y-2 pt-2">
              <div className="relative">
                ...
                <Input
                  placeholder="Buscar sigla ou KM..."
                  value={searchTerm}
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex-1">
                        ...
                        <p className="font-medium">{nec.sigla} - {nec.tipo_inscricao}</p>
