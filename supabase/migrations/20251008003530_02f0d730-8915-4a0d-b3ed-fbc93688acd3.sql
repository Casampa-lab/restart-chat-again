-- Adicionar coluna de código de convite na tabela supervisoras
ALTER TABLE public.supervisoras 
ADD COLUMN codigo_convite TEXT UNIQUE;

-- Gerar códigos únicos para supervisoras existentes
UPDATE public.supervisoras 
SET codigo_convite = UPPER(SUBSTRING(MD5(RANDOM()::TEXT) FROM 1 FOR 8))
