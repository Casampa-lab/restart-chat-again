-- ============================================================
-- INVENTÁRIO DINÂMICO - Sistema Completo de Aplicação de Intervenções
-- ============================================================
-- Este sistema permite aplicar intervenções aprovadas ao inventário,
-- mantendo histórico completo de todas as mudanças.
...
BEGIN
  ...
  -- Aplicar mudanças baseadas no motivo
  CASE v_intervencao.motivo
    ...
    WHEN 'Remoção' THEN
      -- Marcar como removida mas não deletar
      UPDATE public.ficha_marcas_longitudinais SET
        modificado_por_intervencao = true,
        ultima_intervencao_id = p_intervencao_id,
        data_ultima_modificacao = now()
  ...
  -- Marcar intervenção como aplicada
...
-- ============================================================
COMMENT ON FUNCTION public.aplicar_intervencao_marcas_longitudinais IS 'Aplica intervenção aprovada ao inventário de marcas longitudinais, mantendo histórico completo';
COMMENT ON FUNCTION public.aplicar_intervencao_cilindros IS 'Aplica intervenção aprovada ao inventário de cilindros, mantendo histórico completo';
COMMENT ON FUNCTION public.aplicar_intervencao_inscricoes IS 'Aplica intervenção aprovada ao inventário de inscrições/zebrados, mantendo histórico completo';
COMMENT ON FUNCTION public.aplicar_intervencao_defensas IS 'Aplica intervenção aprovada ao inventário de defensas, mantendo histórico completo';
COMMENT ON FUNCTION public.aplicar_intervencao_tachas IS 'Aplica intervenção aprovada ao inventário de tachas, mantendo histórico completo';